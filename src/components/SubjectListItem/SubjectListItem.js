...
const SubjectListItem = ({nombre, periodoDeCursada, añoDeCursada, cursando, nota, id, eliminarMateriaClick, guardarMateriaClick, notas, getSubjects}) => {
    ...
    return (
        <div className="SubjectListItem">
            ...
            {showEditarMateria ? <EditarMateria setShowPopUp={setShowPopUp} nombre={nombre} periodoDeCursada={periodoDeCursada} añoDeCursada={añoDeCursada} cursando={cursando} nota={nota} id={id} guardar={guardarMateriaClick} volver={() => setEditarMateria(false)} notas={notas}></EditarMateria> : <></>}
